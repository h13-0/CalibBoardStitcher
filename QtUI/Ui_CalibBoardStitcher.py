...
class Ui_CalibBoardStitcher(object):
    def setupUi(self, CalibBoardStitcher):
        ...
        self.autoStitchButton = QtWidgets.QPushButton(parent=self.tab_2)
        self.autoStitchButton.setGeometry(QtCore.QRect(210, 90, 100, 30))
        self.autoStitchButton.setObjectName("autoStitchButton")
    ...
    def retranslateUi(self, CalibBoardStitcher):
        ...
        self.autoStitchButton.setText(_translate("CalibBoardStitcher", "执行自动拼接"))
