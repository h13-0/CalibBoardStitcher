...
class Ui_CalibBoardStitcher(object):
    def setupUi(self, CalibBoardStitcher):
        ...
        self.rowCountSpinBox.setGeometry(QtCore.QRect(220, 10, 85, 30))
        ...
        self.colCountSpinBox.setGeometry(QtCore.QRect(220, 50, 85, 30))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 10, 150, 30))
        ...
        self.loadSubImageSequenceButton.setGeometry(QtCore.QRect(210, 10, 100, 30))
        ...
        self.OpenTargetPhotoButton_2 = QtWidgets.QPushButton(parent=self.tab_2)
        self.OpenTargetPhotoButton_2.setGeometry(QtCore.QRect(210, 90, 100, 30))
        self.OpenTargetPhotoButton_2.setObjectName("OpenTargetPhotoButton_2")
        self.comboBox = QtWidgets.QComboBox(parent=self.tab_2)
        self.comboBox.setGeometry(QtCore.QRect(10, 90, 190, 30))
        self.comboBox.setObjectName("comboBox")
        self.importCalibResultButton = QtWidgets.QPushButton(parent=self.tab_2)
        self.importCalibResultButton.setGeometry(QtCore.QRect(210, 50, 100, 30))
    ...
    def retranslateUi(self, CalibBoardStitcher):
        ...
        self.OpenTargetPhotoButton_2.setText(_translate("CalibBoardStitcher", "修改拼接算法"))
